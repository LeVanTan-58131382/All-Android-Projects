...
class SearchCardDog extends StatelessWidget {
  ...
  const SearchCardDog({
    required this.itemOneImg, required this.itemOneTitle, required this.itemOneBgColor, required this.itemOneTextColor, required this.itemTwoImg, required this.itemTwoTitle, required this.itemTwoBgColor, required this.itemTwoTextColor,
  });
