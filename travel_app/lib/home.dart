            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => Padding(
                  ...
                  child: destinationCard(context, destination[index]['imagePath'] as String),
                )
              ),
            ),
            SizedBox(height: 30),
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => 
                  Padding(
                    padding: EdgeInsets.only(left: index  == 0 ? 30: 0),
                    child: hotDestinationCard(hotDestination[index]['imagePath'] as String, hotDestination[index]['placeName'] as String, hotDestination[index]['placeCount'] as String, context ),
                  )
              ),
            ),
            Padding(
